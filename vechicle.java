...
public class vechicle {
    ...
    static int h,id=1000,jj,usid=100,poo=0,minimumdeposit=3000;
    static String h1="";
   ...
   static ArrayList<String>l6=new ArrayList<>();//userpin
    ...
    public static void admin1()
    {
        ...
        System.out.println("7.CHANGE MIMIMUM DEPOSIT");
...
public static void delete()
{
    ...
    System.out.println("VECHCILE ID IS : "+l8.get(i)+"||"+" VECHICLE NUMBER IS : "+l2.get(i)+"||"+" VECHICLE TYPE IS : "+l3.get(i));
}
 int k=sc.nextInt();
 int y=l8.indexOf(k);
 l2.remove(y);
    ...
    public static void loginuser()
    {
        ...
        if(l5.contains(p)&&l6.contains(p1)||p.equals("J")&&p1.equals("10"))
        {
            if(l2.size()<1)
            {
                ...
                for(int i=0;i<l8.size();i++){
                    System.out.println("VECHICLE ID IS : "+l8.get(i)+"||"+" VECHICLE NUMBER IS : "+l2.get(i)+"||"+"VECHICLE QUANTITY : "+l4.get(i)+"||"+"VECHICLE TYPE : "+l3.get(i)+"||"+"VECHICLE PRICE : "+l11.get(i));
                }
                user1();
            }
        }
       ...
       /* else if(y1==6)
        ...
        public static void add()
        {
           ...
           // LocalDate due=LocalDate.plusDays(15);
            ...
            LocalDate due=borrow.plusDays(0);
            l12.add(String.valueOf(due));
            }
        }
        else
        {
            System.out.println("MINIMUM DEPOSIT IS NOT MAINTAINED");
        }
            System.out.println("====PRESS ENTER TO CONTINUE====");
            sc.nextLine();
            String s=sc.nextLine();
...
public static void returnbook()  
       {
           ...
           if(date1.compareTo(date3)!=0)
           {
             ...
             //  int kop=fine-15;
               ...
               System.out.println("YOUR DUE DATE WAS ENDED AT "+l12.get(l121));
               System.out.println();
...
public static void mini(){
    ...
    System.out.println("ENTER THE AMOUNT");
    String amon=sc.next();
    minimumdeposit=Integer.parseInt(amon);
    System.out.println();
